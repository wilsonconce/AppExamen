...
a persistence unit "examenconcewilsonclientePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenconcewilsoncliente\pom.xml":
...
artifact ("examenconcewilsoncliente.war") is already built. You can build
